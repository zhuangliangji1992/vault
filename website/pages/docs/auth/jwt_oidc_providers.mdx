...
will be used for Identity group alias association. The user information
obtained from G Suite can be used to copy claims data into resulting auth token and alias metadata
via [claim_mappings](/api/auth/jwt#claim_mappings).
...
You need to follow **all steps** in the [guide](https://developers.google.com/admin-sdk/directory/v1/guides/delegation)
