...
To clean up dead servers automatically, enable [dead server cleanup in the
autopilot configuration](https://learn.hashicorp.com/tutorials/vault/raft-autopilot?in=vault/raft).
